<div class="card shadow mb-4">
	...
	<div class="card-body"><div class="table-responsive">
		...
		<tr><td><?php echo $no++ ?></td>
			...
			<td><a href="<?php echo base_url('index.php/Mahasiswa/edit/'.$baris->id); ?>" class="fa fa-edit">&nbsp;
				<a href="<?php echo base_url('index.php/Mahasiswa/hapus/'.$baris->id); ?>" class="fa fa-times"></td></tr>
		<?php } ?>
		</tbody>
		</table>
